        ...
        <section className='w-[90%] mx-auto my-10'>
            <div className="flex flex-col md:flex-row gap-10">
                ...
                {/* blog categories */}
                    <div className="">
                        ...
                        <div className="mt-3">
                            <div className="flex justify-between p-2 border-b-2">
                                <h3 className='text-lg font-bold text-black'>Food</h3>
                                <h3 className='text-lg font-bold text-gray-400'>(12)</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex rounded-lg items-center bg-green-200 shadow-xl">
                        <figure><img className="h-[100px] w-[100px] rounded-l-lg" src={blog?.img} alt="img"/></figure>
                        <div className="ml-5">
                            <h2 className="text-md font-semibold hover:text-orange-400 hover:cursor-pointer">{blog?.title}</h2> 
