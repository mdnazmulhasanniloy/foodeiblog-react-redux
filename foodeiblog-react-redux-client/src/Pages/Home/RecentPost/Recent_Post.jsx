...
const RecentPost = () => {
    ...
    if(blogs.length > 0) {
         recentBlogs = blogs.sort((a, b) => a.firstUploadDate - b.firstUploadDate)
    }
    return (
        <section className="mt-10">
            ...
            <img src={recentBlogs[0]?.img} className="w-full h-full object-cover" alt="" />
            ...
            <div className="absolute bottom-32 left-4">
                ...
                <h3 className='text-5xl text-white '>{recentBlogs[0]?.title}</h3>
            </div>
